                ...
                <div class="col-lg-8">
                    <div class="row">
                                ...
                                <div class="bg-white border border-top-0 p-4">
                                    <div class="mb-2">
                                        <a class="badge badge-primary text-uppercase font-weight-semi-bold p-2 mr-2"
                                            href="./single.php">Business</a>
                                        <a class="text-body" href="./single.php"><small>Jan 01, 2045</small></a>
                                    </div>
                        ...
                        <div class="col-lg-12 mb-3">
                            <a href="./single.php"><img class="img-fluid w-100" src="img/ads-728x90.png" alt=""></a>
                        </div>
                        <div class="col-lg-6">
                            <div class="position-relative mb-3">
        ...
        <div class="row py-4">
            ...
            <div class="col-lg-3 col-md-6 mb-5">
                ...
                <div class="mb-3">
                    ...
                    <a class="small text-body text-uppercase font-weight-medium" href="./single.php">Lorem ipsum dolor
            ...
            <div class="col-lg-3 col-md-6 mb-5">
                ...
                <div class="m-n1">
                    <a href="./single.php" class="btn btn-sm btn-secondary m-1">Politics</a>
                    <a href="./single.php" class="btn btn-sm btn-secondary m-1">Business</a>
                    <a href="./single.php" class="btn btn-sm btn-secondary m-1">Corporate</a>
                    <a href="./single.php" class="btn btn-sm btn-secondary m-1">Business</a>
                    <a href="./single.php" class="btn btn-sm btn-secondary m-1">Health</a>
                    <a href="./single.php" class="btn btn-sm btn-secondary m-1">Education</a>
                    <a href="./single.php" class="btn btn-sm btn-secondary m-1">Science</a>
                    <a href="./single.php" class="btn btn-sm btn-secondary m-1">Business</a>
                    <a href="./single.php" class="btn btn-sm btn-secondary m-1">Foods</a>
                    <a href="./single.php" class="btn btn-sm btn-secondary m-1">Entertainment</a>
                    <a href="./single.php" class="btn btn-sm btn-secondary m-1">Travel</a>
                    <a href="./single.php" class="btn btn-sm btn-secondary m-1">Lifestyle</a>
                    <a href="./single.php" class="btn btn-sm btn-secondary m-1">Politics</a>
                    <a href="./single.php" class="btn btn-sm btn-secondary m-1">Business</a>
                    <a href="./single.php" class="btn btn-sm btn-secondary m-1">Corporate</a>
                    <a href="./single.php" class="btn btn-sm btn-secondary m-1">Business</a>
            ...
            <div class="col-lg-3 col-md-6 mb-5">
                ...
                <div class="row">
                    <div class="col-4 mb-3">
                        <a href="./single.php"><img class="w-100" src="img/news-110x110-1.jpg" alt=""></a>
                    </div>
                    <div class="col-4 mb-3">
                        <a href="./single.php"><img class="w-100" src="img/news-110x110-2.jpg" alt=""></a>
                    </div>
                    <div class="col-4 mb-3">
                        <a href="./single.php"><img class="w-100" src="img/news-110x110-3.jpg" alt=""></a>
                    </div>
                    <div class="col-4 mb-3">
                        <a href="./single.php"><img class="w-100" src="img/news-110x110-4.jpg" alt=""></a>
                    </div>
                    <div class="col-4 mb-3">
                        <a href="./single.php"><img class="w-100" src="img/news-110x110-5.jpg" alt=""></a>
                    </div>
                    <div class="col-4 mb-3">
                        <a href="./single.php"><img class="w-100" src="img/news-110x110-1.jpg" alt=""></a>
                    </div>
