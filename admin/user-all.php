                        ...
                        <div class="table_sub_parent">
                            <table class="table">
                                ...
                                if(isset($_POST['search'])){
                                    ...
                                    $sql = "SELECT * FROM admin_info WHERE name = '$src_text' OR email = '$src_text'  OR role = '$src_text'";
                                 ...
                                 if(isset($search_query)){
                                    ...
                                    <tr>
                                        ...
                                        <img style="width:60px;height:60px;margin:0 auto;border-radius:90px;" src="upload/<?php echo $row['file']?>" alt=""></div></td>
