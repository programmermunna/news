...
<main class="main_content">
    ...
    <section class="content_wrapper">
        <h4 class="text-xl font-medium">ad All</h4>
        <br>
        <!-- Page Details Title -->
                ...
                <div class="table_content_wrapper">
                    <header class="table_header">
                        <div class="table_header_left">
                            <button class="add_ad_btn px-4 py-2 text-sm bg-blue-600 text-white rounded focus:ring">Add New
                                ad</button>
                        </div>
                    ...
                    <table class="table">
                        ...
                        <tbody id="customers_wrapper" class="text-sm">
                            ...
                            if (isset($_POST['search'])) {
                                ...
                                $sql = "SELECT * FROM ad WHERE name = '$src_text'";
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td class="p-3 border whitespace-nowrap">
                                            ...
                                            <?php } else { ?>
                                                <div class="w-full flex_center gap-1">
                                                    <a data-name="<?php echo $row['name'] ?>" data-id="<?php echo $row['id'] ?>" class="edit_ad_btn btn table_edit_btn">Edit</a>
                                                    <a class="btn table_edit_btn" href="delete.php?src=ad&&id=<?php echo $row['id'] ?>">Delete</a>
                                                </div>
                                            <?php } ?>
                                        </td>
                                    </tr>
                                ...
                                $totalEmpSQL = "SELECT * FROM ad ORDER BY id DESC";
                                ...
                                $empSQL = "SELECT * FROM ad ORDER BY id DESC LIMIT $startFrom, $showRecordPerPage";
                ...
                <div class="add_ad_wrapper add_ad" style="display: none;">
                    ...
                    <div class="fixed w-[96%] md:w-[500px] inset-0 m-auto bg-white rounded shadow z-50 h-fit">
                        ...
                        <div class="p-4 flex items-center justify-end gap-x-3 border-t mt-4">
                            <button class="btn w-fit p-2 bg-blue-600 text-white rounded focus:ring-2" type="submit" name="add_ad">Create ad</button>
