...
if (isset($_POST['add_ad'])) {
    ...
    $insert_ad = mysqli_query($conn, "INSERT INTO ad(name,embed,position) VALUE('$add_ad','$embed_code',6)");
    if ($insert_ad) {
        $msg = "Successfully created a new ad";
        header("location:single-post-ad-2.php?msg=$msg");
    }
}
...
<main class="main_content">
    ...
    <section class="content_wrapper">
        <h4 class="text-xl font-medium">Single Post ads 2</h4>        
        <br>
                ...
                <div class="table_content_wrapper" style="overflow:unset">
                    ...
                    <table class="table">
                        ...
                        <tbody id="customers_wrapper" class="text-sm">
                            <?php
                                $query = mysqli_query($conn, "SELECT * FROM ad WHERE position = 6  ORDER BY id DESC");
                                $i = 0;
                                ...
                                <td class="p-3 border whitespace-nowrap">
                                    ...
                                    <div class="w-full flex_center gap-1">
                                        <a style="cursor:pointer" class="edit_ad_btn btn table_edit_btn"
                                            href="ad-edit.php?src=single-post-ad-2&&id=<?php echo $row['id'] ?>">Edit</a>
                                        <a style="cursor:pointer" class="btn table_edit_btn"
                                            href="delete-ad.php?src=single-post-ad-2&&id=<?php echo $row['id'] ?>">Delete</a>
                                    </div>
                                    <?php } ?>
                                </td>
                            </tr>
