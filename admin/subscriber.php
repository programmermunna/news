                            ...
                            <table class="table">
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td class="p-3 border whitespace-nowrap"><div class="text-center"><a class="btn table_edit_btn" href="delete.php?src=subscribe&&id=<?php echo $row['id']?>">Delete</a></div></td>
