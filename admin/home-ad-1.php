...
if (isset($_POST['add_ad'])) {
    ...
    $insert_ad = mysqli_query($conn, "INSERT INTO ad(name,embed,position) VALUE('$add_ad','$embed_code',2)");
    if ($insert_ad) {
        $msg = "Successfully created a new ad";
        header("location:home-ad-1.php?msg=$msg");
    }
}
                ...
                <div class="table_content_wrapper" style="overflow:unset">
                    ...
                    <table class="table">
                        ...
                        <tbody id="customers_wrapper" class="text-sm">
                            <?php
                                $query = mysqli_query($conn, "SELECT * FROM ad WHERE position = 2  ORDER BY id DESC");
                                $i = 0;
                                ...
                                <td class="p-3 border whitespace-nowrap">
                                    ...
                                    <div class="w-full flex_center gap-1">
                                        <a style="cursor:pointer" class="edit_ad_btn btn table_edit_btn"
                                            href="ad-edit.php?src=home-ad-1&&id=<?php echo $row['id'] ?>">Edit</a>
                                        <a style="cursor:pointer" class="btn table_edit_btn"
                                            href="delete-ad.php?src=home-ad-1&&id=<?php echo $row['id'] ?>">Delete</a>
                                    </div>
                                    <?php } ?>
                                </td>
                            </tr>
