...
if (isset($_GET['id'])) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $order_update = mysqli_query($conn, "UPDATE orders SET name='$name', phone='$phone', email='$email', product_name='$product_name', brand='$brand', category='$category', warranty_fee='$warranty_fee', delivery_fee='$delivery_fee', advance_amount='$advance_amount', due_amount='$due_amount',our_cost='$our_cost', status='$status' WHERE warranty_id='$id'");
                    ...
                    <div style="margin-right:30px;" class="add_page_main_content">
                        <div class="py-5">
                            ...
                            <input required type="text" name="name" placeholder="Full name" class="input"
                                value="<?php echo $orders['name'] ?>" />
                        </div>
                        <div class="py-5">
                            <label>Phone</label>
                            <input required type="text" name="phone" placeholder="Phone" class="input"
                                value="<?php echo $orders['phone'] ?>" />
                        </div>
                        <div class="py-5">
                            <label>Email</label>
                            <input type="text" name="email" placeholder="Email" class="input"
                                value="<?php echo $orders['email'] ?>" />
                        </div>
                        <div class="py-5">
                            <label>City</label>
                        ...
                        <div>
                            <div class="py-5">
                                ...
                                <input required type="text" name="product_name" placeholder="Produc Name" class="input"
                                    value="<?php echo $orders['product_name'] ?>" />
                            </div>
                            <div class="py-5">
                                <label>Brand</label>
                                ...
                                <div style="display: flex;">
                                    ...
                                    <button type="button" style="width:40px; height:40px;"
                                        class="brand_category_plus add_brand_btn">+</button>
                                </div>
                            ...
                            <div style="position: relative;" class="py-5">
                                ...
                                <div style="display: flex;">
                                    <input id="parent_cat" name="category" placeholder="Select Category" type="search"
                                        class="input" value="<?php echo $orders['category'] ?>">
                                    <button type="button" class="brand_category_plus add_category_btn">+</button>
                                </div>

                                <div class="relative categories_ul_ref_parent"
                                    style="display: none;position: absolute;width:100%; overflow:hidden; max-width: 100%;background: white;z-index: 999 !important; overflow:auto;">
                                    <ul class="categories_ul_ref ring-2 mt-2 ring-gray-100 rounded"></ul>
                                    <button type="button"
                                        class="hide_categories_ul_ref_parent absolute right-2 top-2 text-xs px-2 py-1 bg-gray-100 hover:bg-gray-200 rounded">hide</button>
                                </div>
                            </div>

                            <div class="note">
                                <label>Problem:</label>
                                <textarea required class="note_textarea" name="note" id=""
                                    rows="5"><?php echo $product['note']; ?></textarea>
                            </div>
                            ...
                            <div class="p-5 flex flex-col items-left gap-3">
                                    ...
                                    <div class="brand_categroy_content">
                                        <div class="brand_categroy_width">
                                            ...
                                            <input required name="receive_date" type="date" class="input"
                                                value="<?php echo $orders['receive_date'] ?>">
                                        </div>
                                        <div class="brand_categroy_width">
                                            <b>Delivery Date</b>
                                            <input required name="delivery_date" type="date" class="input"
                                                value="<?php echo $orders['delivery_date'] ?>">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="pos_input_item">
                                    <div class="brand_categroy_content">
                                        <div class="brand_categroy_width">
                                            <b>Warranty Fee</b>
                                            <input required name="warranty_fee" type="number" placeholder="Warranty Fee"
                                                class="input warranty_fee"
                                                value="<?php echo $orders['warranty_fee'] ?>">
                                        </div>
                                        <div class="brand_categroy_width">
                                            <b>Delivery Fee</b>
                                            <input required name="delivery_fee" type="number" placeholder="Delivery Fee"
                                                class="input delivery_fee"
                                                value="<?php echo $orders['delivery_fee'] ?>">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="pos_input_item">
                                    <div class="brand_categroy_content">
                                        <div class="brand_categroy_width">
                                            <b>Advanced Amount</b>
                                            <input required name="advanced_amount" type="number"
                                                placeholder="Advanced Amount" class="input advance_amount"
                                                value="<?php echo $orders['advance_amount'] ?>">
                                        </div>
                                        <div class="brand_categroy_width">
                                            <b>Due Amount</b>
                                            <input name="due_amount" type="number" placeholder="Due Amount"
                                                class="input due_amount" value="<?php echo $orders['due_amount'] ?>">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div>
                                    <b>Our Cost</b>
                                    <input name="our_cost" type="number" placeholder="Our Cost" class="input"
                                        value="<?php echo $orders['our_cost'] ?>">
                                </div>
                                ...
                                <input style="cursor:pointer"
                                    class="add_brand_btn btn bg-blue-500 active:bg-blue-700 hover:bg-blue-600 text-white p-2 rounded"
                                    type="submit" name="submit" value="Update Warranty">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="fixed w-[96%] md:w-[500px] inset-0 m-auto bg-white rounded shadow z-50 h-fit">
                    ...
                    <div class="p-4 flex items-center justify-end gap-x-3 border-t mt-4">
                        <button class="btn w-fit p-2 bg-blue-600 text-white rounded focus:ring-2" type="submit"
                            name="add_brand">Create Brand</button>
                        <button style="background:#F87171;color:#fff;"
            ...
            <div class="add_category_wrapper add_category" style="display: none; z-index:999; position:relative;">
                ...
                <div class="fixed w-[96%] md:w-[500px] inset-0 m-auto bg-white rounded shadow z-50 h-fit">
                    ...
                    <div class="p-4 space-y-2">
                        ...
                        <input required name="category" id="cat_name" placeholder="Select Category" type="text"
                            class="input">
                    </div>

                    <div class="p-4 flex items-center justify-end gap-x-3 border-t mt-4">
                        <button class="btn w-fit p-2 bg-blue-600 text-white rounded focus:ring-2" type="submit"
                            name="add_category">Create</button>
                        <button type="button"
                            class="btn w-fit p-2 bg-red-400 rounded focus:ring-2 hide_add_new_cat">Cancel</button>
                    </div>
                </div>
            </div>
        </form>
...
<?php } else {
    ...
    if (isset($_POST['submit'])) {
        ...
        $order_insert_insert = mysqli_query($conn, "INSERT INTO orders( `name`, `phone`, `email`, `product_name`, `brand`, `category`, `receive_date`, `delivery_date`, `warranty_fee`, `delivery_fee`, `advance_amount`, `due_amount`,`our_cost`, `status`, `warranty_id`, `time`) VALUES('$name', '$phone', '$email', '$product_name', '$brand', '$category', '$receive_date', '$delivery_date', '$warranty_fee', '$delivery_fee', '$advance_amount', '$due_amount','$our_cost', '$status','$warranty_id', '$time')");
                ...
                <div class="warranty_content">
                    ...
                    <div class="add_page_main_content">
                        <div>
                            <div class="py-5">
                                <label>Product Name</label>
                                <input required type="text" name="product_name" placeholder="Produc Name"
                                    class="input" />
                            </div>
                            <div class="py-5 brand">
                                <label>Brand</label>
                            ...
                            <div class="note" class="py-5">
                                <label>Problem:</label>
                                <textarea required class="note_textarea" name="note" id="" rows="5"
                                    placeholder="Write something about this product."></textarea>
                            </div>
                    ...
                    <div class="w-full mx-auto bg-white shadow-lg rounded-md border overflow-hidden border-gray-200">
                        <div class="bg-white">
                            <div class="p-5 flex flex-col items-left gap-3">
                                ...
                                <input style="cursor:pointer"
                                    class="add_brand_btn btn bg-blue-500 active:bg-blue-700 hover:bg-blue-600 text-white p-2 rounded"
                                    type="submit" name="submit" value="Create Warranty">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="add_category_wrapper add_brand" style="display: none;">
                ...
                <div class="fixed w-[96%] md:w-[500px] inset-0 m-auto bg-white rounded shadow z-50 h-fit">
                    ...
                    <div class="p-4 flex items-center justify-end gap-x-3 border-t mt-4">
                        <button class="btn w-fit p-2 bg-blue-600 text-white rounded focus:ring-2" type="submit"
                            name="add_brand">Create Brand</button>
                        <button style="background:#F87171;color:#fff;" type="button"
                            class="btn w-fit p-2 bg-red-400 text-white rounded focus:ring-2 hide_add_new_cat">Cancel</button>
                    </div>
                </div>
            </div>
        ...
        <form action="" method="POST">
            <div class="add_category_wrapper add_category" style="display: none; z-index:999; position:relative;">
                ...
                <div class="fixed w-[96%] md:w-[500px] inset-0 m-auto bg-white rounded shadow z-50 h-fit">
                    ...
                    <div class="p-4 flex items-center justify-end gap-x-3 border-t mt-4">
                        <button class="brand_btn btn w-fit p-2 bg-blue-600 text-white rounded focus:ring-2"
                            type="submit" name="add_category">Create</button>
                        <button style="background:#F87171;color:#fff;" type="button"
                            class="btn w-fit p-2 bg-red-400 rounded focus:ring-2 hide_add_new_cat">Cancel</button>
                    </div>
                </div>
