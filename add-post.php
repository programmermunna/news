...
if (isset($_POST['submit'])) {
    ...
    $author_img = $admin_info['author_img'];
    $time = time();
    ...
    $sql = "INSERT INTO post(`author_img`,`email`,`title`, `category`, `tag`, `author`, `reference`, `img`, `status`,`time`, `summery`, `content`,time) VALUE( '$author_img','$email','$title', '$category', '$tag', '$author', '$reference', '$file_name', '$status', '$time', '$summery', '$content','$time')";
